        ...
        <div className="px-6 md:px-16 lg:px-24 xl:px-32 mt-24 bg-primary/10">
            ...
            text-gray-500">
                <div>
                    ...
                    <p className="max-w-[410px] mt-6">We Deliver Fresh groceries and Snacks to your Door.Trusted By thousands, we aim to make yoour shooping experience more affordable and simple..</p>
                </div>
